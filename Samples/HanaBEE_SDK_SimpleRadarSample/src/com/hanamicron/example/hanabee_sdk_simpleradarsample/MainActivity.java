...
import com.hanamicron.beacon.bluetooth.HanaBEE.InfoScanCallback;
...
public class MainActivity extends Activity {
	...
	public void startRangingScan() {
		if (mHanaBEE != null) {
			mHanaBEE.startInfoScan(new InfoScanCallback() {
				@Override
		...
		if (mHanaBEE != null) {
			mHanaBEE.startPositionScan(new HanaBEE.PositionScanCallback() {
				...
				public void onPositionScan(PointDouble trackingResult) {
					...
					setRadarInfo(trackingResult.x, trackingResult.y, mHanaBEE.getPositionNodeList());
